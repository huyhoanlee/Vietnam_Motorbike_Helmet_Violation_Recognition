...
const PenguinCitizen: React.FC<PenguinProps> = ({ isPasswordField, isPasswordVisible, inputPosition }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Body */}
        <ellipse cx="120" cy="160" rx="70" ry="90" fill="#2563EB" />
        
        {/* White belly */}
        <ellipse cx="120" cy="170" rx="55" ry="75" fill="#F9FAFB" />
        
        {/* Head */}
        <circle cx="120" cy="90" r="55" fill="#2563EB" />
        ...
        {/* Citizen Badge */}
        <g transform="translate(85, 135) scale(0.8)">
          <rect x="0" y="0" width="70" height="25" rx="5" fill="#10B981" />
          <text x="35" y="17" fontFamily="Arial" fontSize="12" fontWeight="bold" fill="white" textAnchor="middle">CITIZEN</text>
        </g>
        
        {/* Phone */}
        <rect x="105" cy="155" width="30" height="45" rx="3" fill="#9CA3AF" />
        <rect x="108" cy="158" width="24" height="35" rx="1" fill="#111827" />
        <circle cx="120" cy="198" r="3" fill="#9CA3AF" />
