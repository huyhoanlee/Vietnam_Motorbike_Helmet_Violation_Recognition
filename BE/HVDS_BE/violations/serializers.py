...
from .models import Violation, ViolationStatus, Vehicle, ViolationImages
...
class ViolationByCitizenSerializer(serializers.ModelSerializer):
    class Meta:
        model = Violation
        fields = ['violation_id', 'plate_number', 'location', 'detected_at', 'violation_image']
        ...
        with transaction.atomic():
            ...
            if not violation:
                ...
                if confidence > violation.max_confidence:
                    ...
                    if plate_number != "None" and violation.vehicle_id.plate_number != plate_number:
                        new_vehicle, _ = Vehicle.objects.get_or_create(plate_number=plate_number)
