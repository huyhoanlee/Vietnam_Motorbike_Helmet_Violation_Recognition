# from src.database.db import SessionLocal, insert_row
...
from src.controllers.annotation import NoteAnnotator, TraceAnnotator
from src.controllers.plate_recognition import PlateRecognizer
